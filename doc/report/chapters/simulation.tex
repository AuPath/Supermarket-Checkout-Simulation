...
L'immagine \ref{fig:kde_self_scan} mostra il grafico KDE della simulazione con sole casse self-scan messa a confronto con la simulazione con sole casse standard e jockey. Si nota che c'è nella simulazione con self-scan c'è un momento di massima densità che viene gestita molto bene dal negozio, infatti il tempo medio d'attesa è molto basso, però poi, a causa del collo di bottiglia della cassa riservata, la densità di clienti crolla ma il tempo d'attesa sale di molto.
