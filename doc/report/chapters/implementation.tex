...
Se il cliente, grazie alla sua strategia, calcola che nelle code adiacenti ci sia un tempo di attesa minore rispetto alla propria, secondo una distribuzione di probabilità, la quale aumenta più risulta conveniente cambiare coda, il cliente si muove o meno. \todo{no, parlare del threshold}
